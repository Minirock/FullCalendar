    ...
    */
    ...
    EventSource.prototype.parseEventDefs = function (rawEventDefs) {
        ...
        for (i = 0; i < rawEventDefs.length; i++) {
            //on veut garder la description dans le parsing
            desc= rawEventDefs[i]['description'];
...
var EventDef = /** @class */ (function () {
    ...
    EventDef.generateId = function () {
        ...
        EventDef.uuid+=1;
        var id_generated=EventDef.uuid+text;
        //console.log(id_generated);
        return '_fc' + (id_generated);
    };
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        var description;
        if(typeof eventDef['description'] !='undefined'){
            description=util_1.htmlEscape(eventDef['description']);
        }else{
            description=util_1.htmlEscape(eventDef['miscProps']['description']);
        }
